  ...
  return (
    <AppContentWrapper>
      <PageContainer>
        ...
        <div className="accordion--cont">
          <Accordion title="How To Connect?">
            <p className="accordion--content">Create an account, and Upload your stories</p>
          </Accordion>
          <Accordion title="Who Can Connect?">
            <p className="accordion--content">Future Legacy is currently in a testing phase, so only selected clients will be accepted, however, you can always apply using the apply form (link)</p>
          </Accordion>
        ...
        <h2 className="about--h2--center mar--2">THE TEAM</h2>
      ...
      description="Business Lead"/> */}
        ...
        <h2 className="about--h2--center mar--2">THE ADVISORS</h2>
        <div className="about--horiz--img--cont">
          <TeamImg
